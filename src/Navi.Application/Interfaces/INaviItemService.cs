...
namespace Navi.Application.Interfaces
{
    ...
    public interface INaviItemService
    {
        ...
        /// <summary>Lấy danh sách items theo tên Product Master.</summary>
        Task<List<NaviItemDto>> GetByProductMasterNameAsync(string productName);

        /// <summary>Lấy danh sách items kèm trạng thái History (OK/NG) theo PO và ProductName.</summary>
        Task<List<NaviItemStatusDto>> GetWithHistoryStatusAsync(string productName, string po);
